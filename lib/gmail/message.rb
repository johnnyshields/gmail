module Gmail
  class Message
    ...
    # FIXME TODO: Should use the new <tt>Gmail::Message#remove_label</tt> method, passing `:Inbox` as argument
    def archive!
      move_to('[Gmail]/All Mail')
    end
    
    # Move to given box and delete from others.  
    # FIXME TODO: Should not delete! because messages are ending up in the trash
    ...
    # FIXME TODO: Should be made an alias of <tt>Gmail::Message#add_label</tt>
